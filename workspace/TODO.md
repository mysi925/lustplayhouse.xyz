...
<todo id="custom-domain">
Update footer domain to actual URL
Replace LUSTPLAYHOUSE.FUN in footer with the real domain once set up
</todo>


<todo id="payment-links">
Connect real payment links to pricing buttons
The "Get Basic/Premium/Exclusive" buttons have no href or payment flow attached
</todo>

<todo id="hero-images">
Add real preview images to the carousel
Current carousel may still reference original site media — swap in branded content
</todo>
